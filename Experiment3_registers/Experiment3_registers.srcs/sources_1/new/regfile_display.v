            ...
            case(display_number)
             ...
             // 改动
                ...
                begin
                      ...
                      display_name  <= "_WEN_";
                      case(wen)
                      4'd1:  display_value <= {16'd0,4'd0,4'd0,4'd0,4'd1};
                      4'd2:  display_value <= {16'd0,4'd0,4'd0,4'd1,4'd0};
                      4'd3:  display_value <= {16'd0,4'd0,4'd0,4'd1,4'd1};
                      4'd4 : display_value  <= {16'd0,4'd0,4'd1,4'd0,4'd0};
                      4'd5 : display_value  <= {16'd0,4'd0,4'd1,4'd0,4'd1};
                      4'd6 : display_value  <= {16'd0,4'd0,4'd1,4'd1,4'd0};
                      4'd7 : display_value  <= {16'd0,4'd0,4'd1,4'd1,4'd1};
                      4'd8 : display_value  <= {16'd0,4'd1,4'd0,4'd0,4'd0};
                      4'd9 : display_value  <= {16'd0,4'd1,4'd0,4'd0,4'd1};
                      4'd10: display_value  <= {16'd0,4'd1,4'd0,4'd1,4'd0};
                      4'd11: display_value  <= {16'd0,4'd1,4'd0,4'd1,4'd1};
                      4'd12: display_value  <= {16'd0,4'd1,4'd1,4'd0,4'd0};
                      4'd13: display_value  <= {16'd0,4'd1,4'd1,4'd0,4'd1};
                      4'd14: display_value  <= {16'd0,4'd1,4'd1,4'd1,4'd0};
                      4'd15: display_value  <= {16'd0,4'd1,4'd1,4'd1,4'd1};
                ...
                begin
                      ...
                      display_name  <= "_REN_";
                      case(ren)
                      2'd1:  display_value <= {16'd0,4'd0,4'd1,4'd1,4'd1};
                      2'd2:  display_value <= {16'd0,4'd1,4'd1,4'd0,4'd1};
                      2'd3:  display_value <= {16'd0,4'd1,4'd1,4'd1,4'd1};
                      default: display_value <= {16'd0,4'd0,4'd1,4'd0,4'd1};
                      endcase 
                end
                default :
                begin
